   ...
   */
    ...
    $this->addActionWithoutFiltering('OptionValueToLabel', '\Civi\ActionProvider\Action\Generic\OptionValueToLabel', E::ts('Show option value(s) as their Label(s)'), array(
	  ...
	  $this->addActionWithoutFiltering('SetValue', '\Civi\ActionProvider\Action\Generic\SetValue', E::ts('Set Value'), array(
	    AbstractAction::DATA_MANIPULATION_TAG));
	  $this->addActionWithoutFiltering('RegexReplaceValue', '\Civi\ActionProvider\Action\Generic\RegexReplaceValue', E::ts('Modify Value with Regular Expression'), array(
	    AbstractAction::DATA_MANIPULATION_TAG));
	  $this->addActionWithoutFiltering('MapValue', '\Civi\ActionProvider\Action\Generic\MapValue', E::ts('Map Value'), array(
	    AbstractAction::DATA_MANIPULATION_TAG));
    ...
    $this->addActionWithoutFiltering(
      'ModifyDateValue',
      '\Civi\ActionProvider\Action\Generic\ModifyDateValue',
      E::ts('Modify date value'),
      array(
        AbstractAction::DATA_MANIPULATION_TAG,
      )
    );
    ...
    $this->addActionWithoutFiltering('FindContactByEmail', '\Civi\ActionProvider\Action\Contact\FindContactByEmail', E::ts('Find contact by e-mail') , array(
      AbstractAction::SINGLE_CONTACT_ACTION_TAG,
    ));
    ...
    $this->addActionWithoutFiltering('CreateContributionWithParameters', '\Civi\ActionProvider\Action\Contribution\CreateContributionWithParameters', E::ts('Create contribution (with parameters)'), array(
      AbstractAction::DATA_MANIPULATION_TAG,
      AbstractAction::SINGLE_CONTACT_ACTION_TAG
    ));
    $this->addActionWithoutFiltering('UpdateContribution', '\Civi\ActionProvider\Action\Contribution\UpdateContribution', E::ts('Update contribution'), array(
      AbstractAction::DATA_MANIPULATION_TAG,
      AbstractAction::SINGLE_CONTACT_ACTION_TAG
    ));
