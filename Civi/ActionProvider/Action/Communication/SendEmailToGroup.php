...
class SendEmailToGroup extends AbstractAction {
  ...
  protected function doAction(ParameterBagInterface $parameters, ParameterBagInterface $output) {
    ...
    foreach ($groupContacts as $groupContact) {
      $contact_ids[] = $groupContact['contact_id'];
    }
    ...
    $mailer->send($contact_ids, $subject, $body_text, $body_html, $extra_data, $cc, $bcc);
  }
  ...
  public function getParameterSpecification() {
    ...
    return new SpecificationBag(array(
      new Specification('group_id', 'Integer', E::ts('ID of group to send e-mail to'), true),
